class ServiceBarchart {
    ...
    */
    ...
    updateVis() {
        ...
        vis.aggregatedData = Array.from(serviceCode, ([key, count]) => ({ key, count }));

        const orderedKeys = ['STRSGN', 'LITR-PRV', "TLGR-PRV", "MTL-FRN", "DFLTPLC", "TGGDCLLC", "TRASH-I", "DAPUB1", "PLMB_DEF", "TRSHCRTR", "RCYCLNG", "BLD-RES",
            "RF-COLLT", "YDWSTA-J", "REPAIR96", "YRDWSTTC", "TIRES", "TRREPR", "NCRHMNT", "DFLTCITY", "MOLD", "PTHOLE", "PRKNGYRD", "SVCCMPLT",
            "CRNRCNOF", "DUMP-PVS", "Other"];
